...
let word = ['B', 'I', 'N', 'O', 'C', 'L', 'A', 'R', 'D']; // we store the words as an array
...
let solution = [
"B", "I", "N", "O", "C", "L", "A", "R", "D"]; //Variable qui stockera la solution
let userInput = ["", "", "", "", "", "", "", "", ""]; //Variable qui affiche les lettres 
let 
...
var str2 = str.charAt(i);
	...
	for (let i=0; i < letter.length; i++) {
		...
		} else if (letter[i] !== solution[i]) {
			console.log(" No ! We will kill you next time little piece of shit !");
		} 
	}
	
console.log(letter[5]);// Syntaxe correcte
